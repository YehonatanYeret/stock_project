...
class MainWindow(QMainWindow):
    ...
    def set_dashboard_widget(self, widget):
        """Set the dashboard widget"""
        self.content_stack.removeWidget(self.dashboard_widget)
        self.dashboard_widget = widget
        self.content_stack.insertWidget(0, self.dashboard_widget)
    
    def set_portfolio_widget(self, widget):
        """Set the portfolio widget"""
        self.content_stack.removeWidget(self.portfolio_widget)
        self.portfolio_widget = widget
        self.content_stack.insertWidget(1, self.portfolio_widget)
    
    def set_stocks_widget(self, widget):
        """Set the stocks widget"""
        self.content_stack.removeWidget(self.stocks_widget)
        self.stocks_widget = widget
        self.content_stack.insertWidget(2, self.stocks_widget)
    
    def set_transactions_widget(self, widget):
        """Set the transactions widget"""
        self.content_stack.removeWidget(self.transactions_widget)
        self.transactions_widget = widget
        self.content_stack.insertWidget(3, self.transactions_widget)
    
    def set_settings_widget(self, widget):
        """Set the settings widget"""
        self.content_stack.removeWidget(self.settings_widget)
        self.settings_widget = widget
        self.content_stack.insertWidget(4, self.settings_widget)
    
    def show_auth_error(self, message):
        """Show an error message on the auth screen"""
        self.auth_stack.show_error(message)